...
{
	private CsvLine<TLineNumber>? CurrentCsvLine { get; set; } = new CsvLine<TLineNumber>(default, TLineNumber.Zero);
	public TSum BiggestSumInLines { get; private set; } = TSum.Zero;
	public CsvLine<TLineNumber> LineWithTheBiggestSum {get; private set;} = new CsvLine<TLineNumber>(default, TLineNumber.Zero);
